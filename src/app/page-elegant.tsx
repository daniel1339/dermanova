...
export default function Home() {
  return (
    <div className="min-h-screen dark-bg-gradient elegant-pattern text-white">
      {/* Navbar */}
      ...
      <section id="inicio" className="pt-16 min-h-screen flex items-center justify-center relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-black via-[#1a1a1a] to-[#2d2d2d] elegant-pattern"></div>
      ...
      {/* Servicios Section */}
      <section id="servicios" className="py-20 dark-section-bg elegant-pattern">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      {/* Nosotros Section */}
      <section id="nosotros" className="py-20 dark-bg-gradient luxury-pattern">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
      ...
      {/* Contacto Section */}
      <section id="contacto" className="py-20 dark-section-bg elegant-pattern">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
            ...
            <div className="bg-gradient-to-br from-[#1a1a1a] to-black p-8 rounded-xl border border-[#D4AF37]/20 shadow-lg">
              ...
              <form className="space-y-6">
                <div>
                  ...
                  <input 
                    type="text" 
                    className="w-full px-4 py-3 bg-[#0a0a0a] border border-gray-600 rounded-lg text-white focus:border-[#D4AF37] focus:outline-none"
                ...
                <div>
                  ...
                  <select className="w-full px-4 py-3 bg-[#0a0a0a] border border-gray-600 rounded-lg text-white focus:border-[#D4AF37] focus:outline-none">
                ...
                <button 
                  type="submit"
                  className="w-full bg-[#D4AF37] text-black py-3 rounded-lg font-semibold hover:bg-[#B8860B] transition-colors shadow-lg"
                >
                  Enviar Solicitud
                </button>
              </form>
      ...
      {/* Footer */}
      <footer className="dark-bg-gradient elegant-pattern border-t border-[#D4AF37]/20 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
